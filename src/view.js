...
const createModal = (post, elements) => {
  ...
  const linkEl = elements.modalLink;
...
const messages = {
  mustBeValid: i18n.t('mustBeValid'),
  linkExists: i18n.t('linkExists'),
...
const FormStateHandler = {
  ...
  failed: (errType, elements, i18next) => {
    ...
    // feedback.textContent = messages[errType];
